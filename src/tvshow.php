      ...
      <a class="navbar-brand me-5 " style="padding-left: 20px;text-shadow: -6px 8px 0px #CE5937;"; href="movieGalleryHome.php">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav w-100 justify-content-end m-2">
            ...
            <li class="nav-item">
            <a class="nav-link btn btn-outline active" style="color:#ce682b;padding:10px; text-decoration: none; font-weight: bold;  display: inline;" aria-current="page"" href="">TV-shows</a>
            </li>
